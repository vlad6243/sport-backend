  ...
  const plans = [
    {
      ...
      description: {
        ...
        ua: 'Базова програма для новачків у залі. Фокус на вивчення техніки та адаптація організму до навантажень',
      },
          ...
          exercises: [
            {
              ...
              notes: {
                ...
                ua: 'З допомогою резинки якщо потрібно',
              },
            },
            {
              exerciseName: {
      ...
      equipment: [
        { ru: 'Штанга', en: 'Barbell', ua: 'Штанга' },
        { ru: 'Гантели', en: 'Dumbbells', ua: 'Гантелі' },
        { ru: 'Скамья', en: 'Bench', ua: 'Лавка' },
        { ru: 'Тренажеры', en: 'Machines', ua: 'Тренажери' },
      ],
      goals: {
        ...
        ua: "Вивчення базових вправ, розвиток м'язової маси, поліпшення загальної фізичної форми",
      },
      tips: {
        ...
        ua: "Починайте з легких ваг, фокусуйтеся на техніці. Відпочинок між тренуваннями 1-2 дні обов'язковий",
      },
    ...
    },
    {
      ...
      description: {
        ...
        ua: 'Інтенсивна програма для схуднення з елементами кардіо та силових тренувань',
      },
      ...
      equipment: [
        { ru: 'Гантели', en: 'Dumbbells', ua: 'Гантелі' },
        { ru: 'Скакалка', en: 'Jump Rope', ua: 'Скакалка' },
        { ru: 'Коврик', en: 'Mat', ua: 'Килимок' },
      ],
      goals: {
        ...
        ua: "Зниження відсотка жиру, поліпшення витривалості, збереження м'язової маси",
      },
      tips: {
        ...
        ua: "Слідкуйте за харчуванням - дефіцит калорій обов'язковий. Пийте багато води. Кардіо можна робити вранці натщесерце",
      },
    ...
    },
    {
      ...
      description: {
        ...
        ua: "Просунута програма для росту м'язів з акцентом на базові вправи",
      },
      ...
      equipment: [
        ...
        { ru: 'Гантели', en: 'Dumbbells', ua: 'Гантелі' },
        { ru: 'Тренажеры', en: 'Machines', ua: 'Тренажери' },
        { ru: 'Турник', en: 'Pull-up Bar', ua: 'Турнік' },
      ],
      goals: {
        ...
        ua: "Максимальний набір м'язової маси, збільшення силових показників",
      },
      tips: {
        ...
        ua: 'Профіцит калорій +300-500. Прогресія навантаження щотижня. Мінімум 8 годин сну. Протеїн 2г на кг ваги',
      },
    ...
    },
    {
      ...
      equipment: [{ ru: 'Нет', en: 'None', ua: 'Немає' }],
      goals: {
        ...
        ua: "Підтримання форми, розвиток витривалості, зміцнення м'язів",
      },
      tips: {
        ...
        ua: 'Можна додати рюкзак з книгами для додаткового навантаження. Слідкуйте за технікою',
      },
