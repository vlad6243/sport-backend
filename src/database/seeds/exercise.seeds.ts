  ...
  const exercises = [
    // CHEST EXERCISES
    {
      ...
      tips: {
        ...
        uk: 'Тримайте тіло прямо, не прогинайтеся в попереку',
      },
      commonMistakes: {
        ru: 'Разведение локтей в стороны, провисание бедер',
        en: 'Flaring elbows out to sides, sagging hips',
        uk: 'Розведення ліктів убік, провисання стегон',
      },
    },
    {
      name: {
      ...
      description: {
        ...
        uk: "Класична базова вправа для розвитку грудних м'язів",
      },
      instructions: {
        ...
        uk: '1. Лягте на лаву, візьміть штангу хватом трохи ширше плечей\n2. Опустіть штангу до грудей\n3. Виджміть штангу вгору',
      },
      primaryMuscleGroup: MuscleGroup.CHEST,
      secondaryMuscleGroups: [MuscleGroup.ARMS, MuscleGroup.SHOULDERS],
      ...
      tips: {
        ...
        uk: 'Використовуйте страховку, опускайте штангу повільно',
      },
      commonMistakes: {
        ru: 'Отрыв таза от скамьи, слишком быстрое опускание',
        en: 'Lifting hips off bench, lowering too quickly',
        uk: 'Відрив тазу від лави, занадто швидке опускання',
      },
    },
    {
      name: {
      ...
      description: {
        ...
        uk: "Вправа для верхньої частини грудних м'язів",
      },
      instructions: {
    ...
    // BACK EXERCISES
    {
      ...
      description: {
        ...
        uk: "Базова вправа для розвитку м'язів спини та біцепсів",
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Використовуйте резинку для допомоги якщо потрібно',
      },
      commonMistakes: {
        ru: 'Раскачивание тела, неполная амплитуда движения',
        en: 'Swinging body, incomplete range of motion',
        uk: 'Розгойдування тіла, неповна амплітуда руху',
      },
    },
    {
      name: {
      ...
      description: {
        ...
        uk: "Базова вправа для розвитку найширших м'язів спини",
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Тримайте спину прямою, тягніть ліктями назад',
      },
      commonMistakes: {
        ru: 'Округление спины, использование инерции',
        en: 'Rounding back, using momentum',
        uk: 'Округлення спини, використання інерції',
      },
    },
    ...
    // LEGS EXERCISES
    {
      ...
      description: {
        ...
        uk: 'Король вправ для ніг, розвиває квадрицепси, сідниці та задню поверхню стегна',
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Коліна в напрямку носків, спина пряма, погляд прямо',
      },
      commonMistakes: {
        ru: 'Колени выходят за носки, округление спины, подъем на носки',
        en: 'Knees past toes, rounding back, rising onto toes',
        uk: 'Коліна виходять за носки, округлення спини, підйом на носки',
      },
    },
    {
      name: {
      ...
      description: {
        ...
        uk: "Вправа для задньої поверхні стегна та сідничних м'язів",
      },
      instructions: {
        ...
        uk: '1. Тримайте штангу в руках, ноги на ширині плечей\n2. Нахиліться вперед з прямою спиною\n3. Поверніться у вихідне положення',
      },
      primaryMuscleGroup: MuscleGroup.LEGS,
      ...
      tips: {
        ...
        uk: 'Тримайте штангу близько до ніг, відчувайте розтягнення задньої поверхні',
      },
      commonMistakes: {
        ru: 'Округление спины, сгибание коленей слишком сильно',
        en: 'Rounding back, bending knees too much',
        uk: 'Округлення спини, згинання колін занадто сильно',
      },
    },
    ...
    // SHOULDERS EXERCISES
    {
      ...
      description: {
        ...
        uk: "Базова вправа для розвитку дельтоподібних м'язів",
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Напружуйте прес для стабілізації, не прогинайтеся в попереку',
      },
      commonMistakes: {
        ru: 'Чрезмерный прогиб в пояснице, подталкивание ногами',
        en: 'Excessive lower back arch, leg drive',
        uk: 'Надмірний прогин у попереку, підштовхування ногами',
      },
    },
    {
      name: {
      ...
      tips: {
        ...
        uk: 'Невеликий нахил корпусу вперед, лікті злегка зігнуті',
      },
      commonMistakes: {
        ru: 'Подъем гантелей выше плеч, использование инерции',
        en: 'Raising dumbbells above shoulders, using momentum',
        uk: 'Підйом гантелей вище плечей, використання інерції',
      },
    },
    ...
    // ARMS EXERCISES
    {
      ...
      description: {
        ...
        uk: 'Класична вправа для розвитку біцепсів',
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Тримайте лікті притиснутими до тіла, не розгойдуйтеся',
      },
      commonMistakes: {
        ru: 'Раскачивание корпуса, отведение локтей назад',
        en: 'Swinging body, moving elbows back',
        uk: 'Розгойдування корпусу, відведення ліктів назад',
      },
    },
    {
      name: {
      ...
      description: {
        ...
        uk: 'Вправа для розвитку трицепсів',
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Тримайте лікті нерухомими, працюють тільки передпліччя',
      },
      commonMistakes: {
        ru: 'Разведение локтей в стороны, слишком большой вес',
        en: 'Flaring elbows out, too much weight',
        uk: 'Розведення ліктів убік, занадто велика вага',
      },
    },
    ...
    // ABS EXERCISES
    {
      ...
      description: {
        ...
        uk: "Статична вправа для зміцнення м'язів кора",
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Напружуйте сідниці та прес, дихайте рівно',
      },
      commonMistakes: {
        ru: 'Провисание бедер, подъем таза вверх',
        en: 'Sagging hips, raising hips too high',
        uk: 'Провисання стегон, підйом тазу вгору',
      },
    },
    {
      name: {
      ...
      description: {
        ...
        uk: "Базова вправа для прямого м'яза живота",
      },
      instructions: {
      ...
      tips: {
        ...
        uk: 'Не тягніть голову руками, працюйте пресом',
      },
      commonMistakes: {
        ru: 'Отрыв поясницы от пола, рывки',
        en: 'Lifting lower back off floor, jerking motions',
        uk: 'Відрив попереку від підлоги, ривки',
      },
    },
    ...
    // CARDIO EXERCISES
    {
      ...
      description: {
        ...
        uk: 'Інтенсивна кардіо-вправа для всього тіла',
      },
      instructions: {
    ...
    },
    {
      ...
      description: {
        ...
        uk: 'Кардіо-вправа для розвитку витривалості та координації',
      },
      instructions: {
      ...
      tips: {
        ...
        uk: "Починайте з повільного темпу, обертання від зап'ясть",
      },
      commonMistakes: {
        ru: 'Приземление на всю стопу, слишком высокие прыжки',
        en: 'Landing on full foot, jumping too high',
        uk: 'Приземлення на всю стопу, занадто високі стрибки',
      },
    },
  ];
